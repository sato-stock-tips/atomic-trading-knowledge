...
It is important that the wedge pop reclaims the top two highest of these five EMAs and SMAs, which are EMA 10/20 and SMA 50, 150, 200, such that the price is above all five of these indicators, and the wedge pop is the final pop above these indicators.

The stock ideally in a Stage Two Advance with a wedge pop across on top of the EMAs and SMAs will then drift back to any of the following EMAs and SMAs, such that the price sits neatly on the highest key moving average. From that point, that would be the perfect entry point because risk can be clearly defined, and risk is also less risky because the moving averages underneath the price provides at least five levels of different supports with all five key moving averages. Of all the trade setups, this is the one which has the most [[wide stops]], although it has to be controlled wide
